...
<div style="display: flex;">
  <div style="flex: 1;">
    <h3 align="left">Column 1:</h3>
    <p align="left">
      <a>Here are all the technologies in column 1:</a>
      <ul>
        <li>Technology 1</li>
        <li>Technology 2</li>
      </ul>
  ...
  <div style="flex: 1;">
    <h3 align="left">Column 2:</h3>
    <p align="left">
      <a>Here are all the technologies in column 2:</a>
      <ul>
        <li>Technology 3</li>
        <li>Technology 4</li>
      </ul>
  ...
  <div style="flex: 1;">
    <h3 align="left">Column 3:</h3>
    <p align="left">
      <a>Here are all the technologies in column 3:</a>
      <ul>
        <li>Technology 5</li>
        <li>Technology 6</li>
      </ul>
